"""
NBA Injury Severity — DistilBERT Fine-Tuning
LIN 371 | Varun Ramanathan

Fine-tunes distilbert-base-uncased on the NBA injury severity task.
...
GPU strongly recommended. On a modern GPU (e.g. RTX 3080) this runs
in ~10–15 minutes for 3 epochs over ~7,700 training examples.

Outputs (saved to ./distilbert_output/):
...
MAX_LEN      = 128       # injury notes are short; 128 tokens is plenty
BATCH_SIZE   = 16
EPOCHS       = 3
LR           = 2e-5
...
# ── Class weights (handles MODERATE being underrepresented) ───────────────────
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for step, batch in enumerate(train_loader, 1):
            ...
            # Gradient clipping — standard practice for BERT fine-tuning
